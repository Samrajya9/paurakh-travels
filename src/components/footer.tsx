...
// TODO : Need to add all those page because it is causing errors on production
const NAV_COLUMNS = [
  {
    heading: "Explore",
    links: [
...
export function Footer() {
  ...
  const SOCIAL_LINKS = [
    profile?.contacts.find((contact) => contact.type === "X") && {
      label: "X / Twitter",
      href: profile?.contacts.find((contact) => contact.type === "X")?.value,
      icon: (
        <svg
          width="18"
          height="18"
    ...
    profile?.contacts.find((contact) => contact.type === "INSTAGRAM") && {
      label: "Instagram",
      href: profile?.contacts.find((contact) => contact.type === "INSTAGRAM")
        ?.value,
      icon: (
        <svg
          width="18"
    ...
    profile?.contacts.find((contact) => contact.type === "FACEBOOK") && {
      label: "Facebook",
      href: profile?.contacts.find((contact) => contact.type === "FACEBOOK")
        ?.value,
      icon: (
        <svg
          width="18"
    ...
    profile?.contacts.find((contact) => contact.type === "YOUTUBE") && {
      label: "YouTube",
      href: profile?.contacts.find((contact) => contact.type === "YOUTUBE")
        ?.value,
      icon: (
        <svg
          width="18"
