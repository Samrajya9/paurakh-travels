...
const items = Object.keys(mockNavBarData.seasons) as Array<
  keyof typeof mockNavBarData.seasons
>
const data = mockNavBarData.seasons

export default function SeasonCotenet() {
