  ...
  images: [
    {
      ...
      entityType: "PACKAGE",
      entityId: "cmr7cl5zh001z9nhibpfjqowoasdasd",
      image: {
    ...
    {
      id: "cmr7cl62h00389nhihi8599ioasdasd",
      entityType: "PACKAGE",
      entityId: "cmr7cl5zh001z9nhibpfjqowoasdasd",
      image: {
    ...
    {
      id: "cmr7cl62k003a9nhin5s9n29fasdas",
      entityType: "PACKAGE",
      entityId: "cmr7cl5zh001z9nhibpfjqowoasdasd",
      image: {
...
const packages = [packageData, packageData, packageData]
...
function Header() {
  return (
    <div className="mb-10 flex w-full items-end justify-between gap-4">
      <div>
