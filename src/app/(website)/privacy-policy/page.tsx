...
// Applied to every <ul> below so list items inherit the same font, size,
// and leading as the surrounding <P> text instead of falling back to
// browser default list typography.
...
const SECTIONS: { title: string; body: React.ReactNode }[] = [
  {
    ...
    body: (
      <P variant="md">
        ...
        collects, uses, and protects information when you browse this website or
        book a trekking or travel package with us. By using this site, you agree
  ...
  },
  {
    ...
    body: (
      <>
        <P variant="md">We collect a few different kinds of information:</P>
  ...
  },
  {
    ...
    body: (
      <P variant="md">
        ...
        Manaslu, Mustang, or Langtang regions) legally require a valid trekking
        permit or TIMS card, which in turn requires a copy of your passport and
        proof of travel insurance. We do not currently collect this information
        through the website, but for packages where it becomes a legal
        requirement, we may request your passport or identification details and
        travel insurance documentation directly from you before departure. This
        information is used solely to arrange the required permits and is never
  ...
  },
  {
    ...
    body: (
      <P variant="md">
        ...
        on this website. When you request a booking, we confirm availability and
        send you a confirmation email — payment is made in cash directly with
        our team once you arrive in Nepal. If we introduce online payment
        options in the future, this policy will be updated to describe how that
  ...
  },
  {
    ...
    body: (
      <P variant="md">
        ...
        and travel insurance details collected for permit purposes are kept only
        as long as required for that trip and any related legal record-keeping,
        then deleted.
      </P>
    ),
  },
  {
    ...
    body: (
      <P variant="md">
        ...
        hold about you at any time by contacting us at{" "}
        <Button variant="link" size="lg" asChild className="px-0">
          <Link href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</Link>
        </Button>
        . You can also unsubscribe from newsletter emails using the link in any
        newsletter, or by deleting your account.
      </P>
    ),
  },
  {
    ...
    body: (
      <P variant="md">
        ...
        children, and we do not knowingly collect personal information directly
        from anyone under 18 without a parent or guardian&apos;s involvement in
        the booking.
      </P>
    ),
  },
  {
    ...
    body: (
      <P variant="md">
        ...
        introduce online payments or new analytics tools. We&apos;ll update the
        &quot;last updated&quot; date at the top of this page whenever we do.
      </P>
    ),
  },
  {
